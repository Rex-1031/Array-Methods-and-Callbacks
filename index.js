...
// function getWinnersByYear(callback1, callback2,arr) {
//     const finalWinners = callback1(arr).map(item => item.winners);
//     const finalYears = callback2(arr).map(item => item.Year);
//     // return `In ${finalWinners}, ${} won the world cup!` 
// }
// getWinnersByYear();
